...
public class AudioServicer : AudioService.AudioServiceBase
{
    ...
    public override async Task downloadAudio(DownloadFileRequest request, IServerStreamWriter<DataChunckResponse> responseStream, ServerCallContext context){
        ...
        try
        {
            ...
            {
                await responseStream.WriteAsync(new DataChunckResponse{
